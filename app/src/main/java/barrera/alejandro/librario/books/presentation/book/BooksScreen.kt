...
import barrera.alejandro.librario.books.presentation.book.BooksScreenViewModel
            ...
            SimpleBookCard(
                ...
                onClick = {
                    navController.navigate(
                        route = "bookDetail/${book.id}/${book.title}/${book.author}/${book.description}/${book.color}"
                    )
                }
            )
        }
